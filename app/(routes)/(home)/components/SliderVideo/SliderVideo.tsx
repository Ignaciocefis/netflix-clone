    ...
    <div className="relative w-full -[80vw] md_h-[56.25vw] lg:h-[45vw]">
      {isClient && (
        <video
          ...
          loop
          muted
          className="brightness-50 object-fill w-full h-[80vw] md:[56.25vw] lg:h-[45vw]"
      ...
      <div className="flex flex-col justify-end absolute w-full md:w-[36%] px-4 md:px-0 md:left-[4%] z-20 top-0 -bottom-7 md:bottom-[36%]">
        <div className="pt-24 md:pt-0">
          ...
          <p className="max-w-md mt-2 text-xs md:text-base">
            Al ver que la vida en la Tierra está llegando a su fin, un grupo de
            exploradores dirigidos por el piloto Cooper (McConaughey) y la
            científica Amelia (Hathaway) emprende una misión que puede ser la
            más importante de la historia de la humanidad: viajar más allá de
            nuestra galaxia para descubrir algún planeta en otra que pueda
